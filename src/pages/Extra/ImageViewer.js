...
const ImageViewer = () => {
  ...
  return (
    <div>
      ...
      />
      <img
        src="https://image.shutterstock.com/image-photo/orange-white-cute-cate-260nw-2032079174.jpg"
        alt="image"
        onClick={e => {
          setIsOpen(true)
          setCurrImg(2)
      ...
      <ImgsViewer
        imgs={[
          ...
          {
            src:
              'https://image.shutterstock.com/image-photo/orange-white-cute-cate-260nw-2032079174.jpg'
          }
        ]}
        currImg={currImg}
        showThumbnails={true}
